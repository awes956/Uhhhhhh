...
local xml = "<roblox xmlns:xmime=\"http://www.w3.org/2005/05/xmlmime\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:noNamespaceSchemaLocation=\"http://www.roblox.com/roblox.xsd\" version=\"4\"><External>null</External><External>nil</External>"
local referents = {}
...
local function serialize(inst)
	...
	if inst.ClassName == "KeyframeSequence" then
		xml = xml .. "<float name=\"AuthoredHipHeight\">0</float><bool name=\"Loop\">true</bool><token name=\"Priority\">2</token>"
	end
	if inst.ClassName == "Keyframe" then
		xml = xml .. "<float name=\"Time\">" .. inst.Time .. "</float>"
	end
	if inst.ClassName == "Pose" then
		...
		xml = xml .. "<token name=\"EasingDirection\">" .. inst.EasingDirection .. "</token><token name=\"EasingStyle\">" .. inst.EasingStyle .. "</token>"
		xml = xml .. "<float name=\"Weight\">" .. inst.Weight .. "</float>"
		xml = xml .. "<CoordinateFrame name=\"CFrame\"><X>" .. inst.CFrame[1] .. "</X><Y>" .. inst.CFrame[2] .. "</Y><Z>" .. inst.CFrame[3] .. "</Z><R00>" .. inst.CFrame[4] .. "</R00><R01>" .. inst.CFrame[5] .. "</R01><R02>" .. inst.CFrame[6] .. "</R02><R10>" .. inst.CFrame[7] .. "</R10><R11>" .. inst.CFrame[8] .. "</R11><R12>" .. inst.CFrame[9] .. "</R12><R20>" .. inst.CFrame[10] .. "</R20><R21>" .. inst.CFrame[11] .. "</R21><R22>" .. inst.CFrame[12] .. "</R22></CoordinateFrame>"
	end
	xml = xml .. "</Properties>"
