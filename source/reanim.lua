				...
				for _,v in character:GetDescendants() do
					if v:IsA("Motor6D") then
						...
						elseif v.Name == "Neck" then
							...
							Util.SetMotor6DOffset(v, torsooffset.Rotation:Inverse() * CFrame.new(i * -3, 0, -2 + math.random() * 0.05))
							i += 1
						end
					end
				end
...
UI.CreateText(CreditsPage, "* Credits to *", 15, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "rez aka @chiptune", 14, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "wow cool 64k demos, great inspiration", 12, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "AALib & BB Demo", 14, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, "Polariaus", 14, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, "Awesome Awes955", 14, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, math.random() < 0.67 and "Tatsuki" or "Kaylie", 14, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, "Dubmood", 14, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, "4mat", 14, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "pls dont kick dubmood's ass lol", 12, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "pouet.net", 14, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "other than rez' demos theres lots of good demos there", 12, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, "github.com", 14, Enum.TextXAlignment.Center)
...
UI.CreateText(CreditsPage, "Those require script databases", 14, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "bro 99% of the characters are LORELESS and SILENT", 12, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "my math teacher", 14, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "i LOVE your method of teaching! its fun!!", 12, Enum.TextXAlignment.Center)
UI.CreateText(CreditsPage, "return_request", 14, Enum.TextXAlignment.Center)
...
UI.CreateSeparator(CreditsPage)
UI.CreateText(CreditsPage, "(C) 2026 STEVETHEREALONE", 14, Enum.TextXAlignment.Center)
